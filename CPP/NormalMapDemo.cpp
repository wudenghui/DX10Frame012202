...
class NormalMap : public GameObj
{
public:
	NormalMap();
	~NormalMap();
...
NormalMap::NormalMap()
: mFloorMapRV(0), mFloorNormalMapRV(0), 
...
void NormalMap::ActionUpdate(float dt)
{
...
void NormalMap::DrawContent()
{
	...
	md3dDevice->IASetInputLayout(PosTangentNormalTex);
